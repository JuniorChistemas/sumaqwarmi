...
class AdministradorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _listProductos(productoBloc),
      floatingActionButton: _crearBotom(context),
    );
  }
  Widget _listProductos(ProductoBloc productoBloc) {
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                onDismissed: (direccion) {
                  ...
                  productoBloc.BorrarProductos(producto.idu!);
                },
                child: Card(
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Navigator.pushNamed(
                              context, 'producto', arguments: producto);
                        },
                      ),
                    ],
                  ),
